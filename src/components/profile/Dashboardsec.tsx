...
const Dashboardsec = () => {
  ...
  return (
    <>
      <MaxWidthWrapper>
        <AnimatedGradientText className="pb-4">Highlights</AnimatedGradientText>
        <p className=" text-zinc-700 sm-text-l font-semibold text-center pb-5">
          We have successfully reached out many events. As we reflect back, here
          are some of the events organized by CSI!
        </p>
