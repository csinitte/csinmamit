...
const Testimonial: FunctionComponent<TestimonialsProps> = ({
  ...
  return (
    <div className="mb-8 sm:break-inside-avoid">
      <div className="hover:blue-yellow-300 block rounded-xl border bg-gray-900/5 p-6 shadow-xl ring-1 ring-inset ring-gray-900/10 transition-all duration-300 hover:scale-[1.05] hover:shadow-blue-500/25 dark:bg-gray-900/10">
